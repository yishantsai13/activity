...
<body onload="MM_preloadImages('image/choose/21.gif','image/choose/22.gif','image/choose/25.gif','image/login2.png','image/logout2.png')">
<div id="wrapper">

<?php
$a_id = $_GET['aid'];
$sid = $_GET['sid'];
$row=mysql_fetch_array(mysql_query("SELECT * FROM `activity` WHERE activity_id=".$a_id));
$row_img=mysql_fetch_array(mysql_query("SELECT * FROM `activity_file` WHERE cover=1 AND activity_id=".$a_id));
?>
  	...
  	<td>
			<table id="___01" width="1000" height="120" border="0" cellpadding="0" cellspacing="0">
              <tr>
				...
				<td><a href="sign.php?activity_id=<?php echo $a_id;?>&amp;sid=<?php echo $sid;?>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','image/choose/25.gif',1)"><img src="image/choose/15.gif" alt="我要報名" width="224" height="120" id="Image5" /></a></td>
...
<!-- Start -->
    ...
    <tr bgcolor="DDEADE">
      ...
      <td valign="top"><?php 
		$result_filelist=mysql_query("SELECT * FROM activity_file WHERE  activity_id=".$a_id);
