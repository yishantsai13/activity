...
<body onload="MM_preloadImages('image/choose/21.gif','image/choose/22.gif','image/choose/24.gif','image/login2.png','image/logout2.png')">
<div id="wrapper">
...
<!-- Start --> 
    ...
    <tr>
      ...
      <td width="21%" align="right" class="m_word" bgcolor="CEE2D0"><font Face="標楷體" size="4"><b>活 動 名 稱：</b></font></td>
      <td width="42%" bgcolor="CEE2D0"><font size="2"><?php echo $row['name']; ?></font></td>
